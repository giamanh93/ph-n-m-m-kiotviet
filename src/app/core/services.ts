...
export class DataService {
    ...
    public addProduct<T>(params): Observable<T> {
        return this.http.post<T>(this.actionUrl + 'product', params);
    }
    public listProduct<T>(): Observable<T> {
        return this.http.get<T>(this.actionUrl + 'product');
    }
    public updateProduct<T>(id: string, params: any): Observable<T> {
        return this.http
            .put<T>(this.actionUrl + 'product/' + id, params);
    }
    public deleteProduct<T>(id: string): Observable<T> {
        return this.http.delete<T>(this.actionUrl + 'product/' + id);
    }
    ...
    public infoUser<T>(): Observable<T> {
        return this.http.get<T>(this.actionUrl + 'user/info', { withCredentials: true });
    }
    public infologout<T>(): Observable<T> {
        return this.http.get<T>(this.actionUrl + '/user/logout');
    }
    public login<T>(params): Observable<T> {
        return this.http.post<T>(this.actionUrl + 'user/login', params, { withCredentials: true });
    }
